          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-2">
                ...
                <a href={`tel:${SITE_CONFIG.site.phone}`} className="text-muted-foreground hover:text-primary transition-colors text-sm" dir="ltr">{SITE_CONFIG.site.phone}</a>
              </li>
               <li className="flex items-center gap-2">
                ...
                <a href={`https://wa.me/${SITE_CONFIG.site.whatsapp}`} target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors text-sm" dir="ltr">{SITE_CONFIG.site.whatsapp}</a>
              </li>
            </ul>
          </div>
        </div>
